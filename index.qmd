...
## About Me {style="font-size: 30px; line-height: 1.5;" .light-centered .center}
...
- My name is Pingfan Hu, a PhD Candidate at George Washington University, advised by Dr John Helveston
</div>
...
Throughout the past decade, the US market has witnessed a significant surge in electric vehicle sales, reaching about 10% of all vehicles. The BEVs, short for Battery Electric Vehicles, takes the majority of them. However, the high ownership of BEVs has brought challenges to the grid. 
:::
...
::: {.notes}
Unmanaged BEV charging is becoming a problem to the grid due to the spike. That's why we need managed charging to smooth out the grid load as well as keeping the price low.
...
::: {.notes}
However, the effectiveness of smart charging is really depending on the enrollment of the BEV owners.
:::
...
::: {.notes}
This is how we did it. In this Car Ownership section, we asked how many cars do they have. Then based on the number of cars, they need to select their make, model, and year of them. If at least one of them is a BEV, then we consider the participant as a BEV owner. Instead of asking if they own a BEV, this is a more reliable way.
:::
